        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                Welcome to Cloud Security Bootcamp, where we specialize in
                practical AWS security training. Our hands-on labs mimic real-world
                challenges, allowing you to test your skills and gain confidence
                in cloud security.
              </p>
